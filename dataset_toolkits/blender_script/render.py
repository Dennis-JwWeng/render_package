...
def init_render(engine='CYCLES', resolution=512, geo_mode=False, use_cpu=False):
...
def main(arg):
    ...
    init_render(engine=arg.engine, resolution=arg.resolution, geo_mode=arg.geo_mode,
                use_cpu=getattr(arg, 'use_cpu', False))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_cpu', action='store_true', help='Use CPU rendering instead of GPU.')
