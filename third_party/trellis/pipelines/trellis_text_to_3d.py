...
class TrellisTextTo3DPipeline(Pipeline):
    ...
    def sample_slat(
        ...
        if noise is None:
            print("stage2's noise is not provided!!!")
    ...
    def run(
        ...
        slat = self.sample_slat(cond, coords, noise=None, sampler_params=slat_sampler_params)
        # torch.save(slat.feats, "outputs/slat/foresthouse_ori_feats.pt")
        # torch.save(slat.coords, "outputs/slat/foresthouse_ori_coords.pt")
    ...
    def run_variant(
        ...
        torch.manual_seed(seed)
        slat = self.sample_slat(cond, coords, noise=None, slat_sampler_params=slat_sampler_params)
        return self.decode_slat(slat, formats)
